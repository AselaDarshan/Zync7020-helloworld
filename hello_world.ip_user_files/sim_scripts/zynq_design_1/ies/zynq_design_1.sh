...
#
# Generated by Vivado on Thu Sep 29 23:54:49 +0530 2016
...
# Script info
echo -e "zynq_design_1.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./zynq_design_1.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    ...
    "$ref_dir/../../../bd/zynq_design_1/ip/zynq_design_1_blk_mem_gen_0_0/sim/zynq_design_1_blk_mem_gen_0_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/zynq_design_1/ip/zynq_design_1_rst_processing_system7_0_100M_0/sim/zynq_design_1_rst_processing_system7_0_100M_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/zynq_design_1/hdl/zynq_design_1.vhd" \
...
elaborate()
{
  ...
  libs="-libname unisims_ver -libname unimacro_ver -libname secureip -libname xil_defaultlib -libname axi_lite_ipif_v3_0_3 -libname lib_cdc_v1_0_2 -libname interrupt_control_v3_1_3 -libname axi_gpio_v2_0_9 -libname blk_mem_gen_v8_3_1 -libname axi_bram_ctrl_v4_0_6 -libname proc_sys_reset_v5_0_8 -libname generic_baseblocks_v2_1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_7 -libname fifo_generator_v13_0_1 -libname axi_data_fifo_v2_1_6 -libname axi_crossbar_v2_1_8 -libname axi_protocol_converter_v2_1_7"
  ncelab $opts xil_defaultlib.zynq_design_1 xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.zynq_design_1 -input simulate.do
}
# Script usage
usage()
{
